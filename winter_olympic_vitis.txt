...
#define alarm_addr XPAR_MYIP_ALARM_0_BASEADDR
...
unsigned int *alarm_device = (unsigned int*) alarm_addr;
...
//     void buzzer_test() {
//     xil_printf("Buzzer Test Start...\r\n");
    
//     // 약 500번 반복 (1ms 켜고 1ms 끄면 2ms 주기 = 500Hz)
//     for (int i = 0; i < 500; i++) {
//         // 1. 부저 켜기 (slv_reg5 = 1)
